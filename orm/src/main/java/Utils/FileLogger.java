...
/**
 * FileLogger - Singleton used to log exceptions and other info to a file or maybe another data source
...
public class FileLogger {
    ...
    private String formatStackTrace(Exception e) {
        //2 is the most recent stack frame from before this file
